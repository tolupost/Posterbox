...
import 'package:posterbox/sendPackage/screens/sendPackagescreen3.dart';
...
class sendPackagescreen2 extends StatefulWidget {

  final String  senderaddress,sendername,sendernumber,state1;
  const sendPackagescreen2({Key? key, required this.senderaddress, required this.sendername, required this.sendernumber, required this.state1, }) : super(key: key);

  @override
  State<sendPackagescreen2> createState() => _sendPackagescreen2State();
}

class _sendPackagescreen2State extends State<sendPackagescreen2> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(animation: animationController!, builder: (context, child){
      ...
      child: Column(
                  ...
                  children: [
                    Text('Who are you Sending to?',style: globalvariable.lgtext,),
      ...
      child:CustomButton(text: 'Continue', onTap: (){
            ...
            Navigator.push(context,  MaterialPageRoute(
              builder: (context) =>   sendPackagescreen3(
                senderaddress: widget.senderaddress,
                sendername: widget.sendername,
                sendernumber: widget.sendernumber,
                recevieraddress: _emailController.text,
                receviername: '${ _nameController.text}.${dropdownvalue}',
                receviernumber: _phoneController.text,
                state1: widget.state1,
                state2: dropdownvalue,),
            ));
         }))),
        ],
      ),
