...
class globalvariable{
  static const primarycolor = Color(0xFFAA0000);
  static const backgroundcolor = Color.fromARGB(255,254, 254, 254);
  static const backgroundcard = Color.fromARGB(255, 144, 37, 37);

  static TextStyle lgtext= TextStyle(fontFamily: 'Inter',fontWeight: FontWeight.w500, fontSize: 18.sp,color: Color.fromARGB(255, 42, 42, 42));
  ...
  static TextStyle lgtext3= TextStyle(fontFamily: 'Inter',fontWeight: FontWeight.w500, fontSize: 14.sp,color: Color.fromARGB(255, 42, 42, 42));
  ...
  static TextStyle lgtext6= TextStyle(fontFamily: 'Inter',fontWeight: FontWeight.w400, fontSize: 12.sp,color: Color.fromARGB(255, 42, 42, 42));
  static TextStyle lgtext7= TextStyle(fontFamily: 'Inter',fontWeight: FontWeight.w600, fontSize: 20.sp,color: Color.fromARGB(255, 42, 42, 42));
